...
* [WebForms Core Technology](https://github.com/elanatframework/Web_forms_classes/tree/elanat_framework/r) - A web technology for manipulating HTML DOMs via the server.
